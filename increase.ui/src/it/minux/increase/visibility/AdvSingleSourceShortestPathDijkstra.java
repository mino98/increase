 ...
 */
public class AdvSingleSourceShortestPathDijkstra<CostType> extends
	AdvDijkstra<CostType> implements SingleSourceShortestPath<CostType>
{
     ...
     * @see Dijkstra
     */
    public AdvSingleSourceShortestPathDijkstra( CostType startCost,
        Node startNode, AdvCostEvaluator<CostType> costEvaluator,
