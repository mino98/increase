 ...
 */
public class AdvDijkstra<CostType> implements
        SingleSourceSingleSinkShortestPath<CostType>
{
    ...
    protected AdvCostEvaluator<CostType> costEvaluator = null;
     ...
     */
    public AdvDijkstra( CostType startCost, Node startNode, Node endNode,
    		AdvCostEvaluator<CostType> costEvaluator,
            ...
            else
            {
                ...
                for ( RelationshipType costRelationType : costRelationTypes )
                {
                            ...
                            costRelationType, getDirection() ) )
                    {
                        ...
                        List<Node> previousNodes = Util.constructSinglePathToNodeAsNodes( currentNode,
                                predecessors, true, false );
                        
//                        List<Node> previousNodes = new ArrayList<Node>(0);
